...
export function musicTrackEligibility(track, {
  ...
  if (asset.libraryType === "RUVANAS_CATALOGUE") {
    ...
    if (asset.licensedCatalogue === true) {
      ...
      if (track.catalogueProvider === "PROMO_ONLY" && !territory && !/\b(WORLDWIDE|GLOBAL|ALL)\b|\*/i.test(String(track.permittedTerritories || ""))) return { playable: false, reason: "TERRITORY_REQUIRED" };
