...
export const subscriberNotificationDetails = Object.freeze({
  ...
  LISTENER_REQUEST: { label: "Listener request", category: "Audience", actionLabel: "Open station", href: "/dashboard/radio" },
  CORRECTIONS_REVIEW_REQUEST: { label: "Inside review requested", category: "Ruvanas Inside", actionLabel: "Review programme", href: "/dashboard/corrections/programmes" }
});
