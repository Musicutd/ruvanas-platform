export const RUVANAS_PRODUCTS = Object.freeze(["RETAIL", "SCHOOL", "ONLINE", "HEALTH", "FAITH", "ORGANISATIONS", "CORRECTIONS"]);
...
function productCapabilities(product) {
  return {
    ...
    organisationsEnabled: product === "ORGANISATIONS",
    correctionsRadioEnabled: product === "CORRECTIONS"
  };
}
...
export const PUBLIC_PLAN_CATALOGUE = Object.freeze([
  ...
  definePlan({
    code: "ORGANISATIONS_START",
    publicSlug: "organisations-start",
    productFamily: "ORGANISATIONS",
    tierNumber: 1,
    name: "Organisations Start",
    monthlyPriceCents: 2490,
    stationLimit: 1,
    storageLimitGb: 25,
    listenerLimit: 250,
    maxBitrateKbps: 192,
    description: "One subscriber-operated channel with announcements, event planning and rights-cleared uploads."
  }),
  definePlan({
    code: "ORGANISATIONS_CONNECT",
    publicSlug: "organisations-connect",
    productFamily: "ORGANISATIONS",
    tierNumber: 2,
    name: "Organisations Connect",
    ...
    maxBitrateKbps: 256,
    digitalSignageEnabled: true,
    description: "Two channels with podcasts, live events, Studio production and connected displays."
  }),
  definePlan({
    code: "ORGANISATIONS_PRO",
    publicSlug: "organisations-pro",
    productFamily: "ORGANISATIONS",
    tierNumber: 3,
    name: "Organisations Pro",
    ...
    maxBitrateKbps: 320,
    digitalSignageEnabled: true,
    description: "Five channels, a focused catalogue, governed sponsors, campaigns and evidence."
  }),
  definePlan({
    code: "ORGANISATIONS_NETWORK",
    publicSlug: "organisations-network",
    productFamily: "ORGANISATIONS",
    tierNumber: 4,
    name: "Organisations Network",
    ...
    maxBitrateKbps: 320,
    digitalSignageEnabled: true,
    description: "Multi-branch governance, delegated operations and professional catalogue controls."
  }),
  definePlan({
    code: "ORGANISATIONS_ENTERPRISE",
    publicSlug: "organisations-enterprise",
    productFamily: "ORGANISATIONS",
    tierNumber: 5,
    name: "Organisations Enterprise",
    monthlyPriceCents: 69900,
    stationLimit: 50,
    storageLimitGb: 3000,
    listenerLimit: 100000,
    maxBitrateKbps: 320,
    digitalSignageEnabled: true,
    enterpriseContactRequired: true,
    description: "Enterprise identity, custom scale, priority service and premium catalogue reporting."
  }),
  definePlan({
    code: "CORRECTIONS_ESSENTIAL",
    publicSlug: "corrections-essential",
    productFamily: "CORRECTIONS",
    tierNumber: 1,
    name: "Inside Essential",
    monthlyPriceCents: 14900,
    stationLimit: 1,
    storageLimitGb: 25,
    listenerLimit: 100,
    maxBitrateKbps: 192,
    description: "Foundation for one facility's internal audio. Private delivery and facility policy require later setup."
  }),
  definePlan({
    code: "CORRECTIONS_FACILITY",
    publicSlug: "corrections-facility",
    productFamily: "CORRECTIONS",
    tierNumber: 2,
    ...
    listenerLimit: 500,
    maxBitrateKbps: 256,
    description: "A single-facility tier for supervised production and governed programming as those workflows become available."
  }),
  definePlan({
    code: "CORRECTIONS_REHABILITATION_PRO",
    publicSlug: "corrections-rehabilitation-pro",
    productFamily: "CORRECTIONS",
    tierNumber: 3,
    name: "Inside Rehabilitation Pro",
    monthlyPriceCents: 59900,
    stationLimit: 1,
    storageLimitGb: 250,
    listenerLimit: 2000,
    maxBitrateKbps: 320,
    description: "Flagship single-facility tier with Studio Pro and a focused catalogue, subject to Corrections rights and policy."
  }),
  definePlan({
    code: "CORRECTIONS_NETWORK",
    publicSlug: "corrections-network",
    productFamily: "CORRECTIONS",
    tierNumber: 4,
    name: "Inside Network",
    ...
    listenerLimit: 10000,
    maxBitrateKbps: 320,
    description: "Multi-facility commercial tier; central and local governance will be delivered in a later stage."
  }),
  definePlan({
    code: "CORRECTIONS_JUSTICE_ENTERPRISE",
    publicSlug: "corrections-justice-enterprise",
    productFamily: "CORRECTIONS",
    tierNumber: 5,
    name: "Justice Enterprise",
    ...
    maxBitrateKbps: 320,
    enterpriseContactRequired: true,
    description: "Custom correctional-network scale and governance, subject to an individually agreed deployment."
  })
]);

export function validatePublicPlanCatalogue(plans = PUBLIC_PLAN_CATALOGUE) {
  if (!Array.isArray(plans) || plans.length !== 35) throw new Error("The public plan catalogue must contain exactly thirty-five plans.");
  ...
  for (const plan of plans) {
    ...
    const enabledProducts = [plan.retailRadioEnabled, plan.schoolRadioEnabled, plan.onlineRadioEnabled, plan.healthRadioEnabled, plan.faithRadioEnabled, plan.organisationsEnabled, plan.correctionsRadioEnabled].filter(Boolean).length;
