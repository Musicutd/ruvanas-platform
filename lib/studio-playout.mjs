...
export function studioQueueReadiness(asset, { licensedCatalogueEnabled = false, licensedMusicCatalogueEnabled = false, licensedMusicCatalogueLevel = null } = {}) {
  ...
  if (asset.licensedCatalogue === true) {
    ...
    if (!catalogueLevelAllows(licensedMusicCatalogueLevel, track.minimumCatalogueLevel || "FOCUSED")) return { ready: false, reason: "This catalogue track requires a higher plan." };
