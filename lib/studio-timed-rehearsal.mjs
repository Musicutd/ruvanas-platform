...
export function renderTimedRehearsalBundle(plan, {
  ...
  return {
    ...
    expectedOrder: plan.items.map((item) => ({ position: item.position, trackId: item.trackId,
      startOffsetSeconds: item.startOffsetSeconds, endOffsetSeconds: item.endOffsetSeconds })),
    commandIssued: false,
