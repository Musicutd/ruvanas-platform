...
export const subscriberHelpArticles = Object.freeze([
  ...
  },
  {
    ...
    title: "Create a location and playback area",
    summary: "Set up physical Retail or School sites before preparing players and displays.",
    keywords: ["location", "zone", "area", "shop", "school", "display", "signage"],
    steps: [
      "Open Locations & Zones from Audio & playout.",
      "Add the physical location name, its real timezone and the first area used by a player or display.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Viewers can review service state but cannot change locations, areas or shop players.",
