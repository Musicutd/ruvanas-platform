...
const PRODUCT_LABELS = Object.freeze({
  ...
  HEALTH: "Ruvanas Health", FAITH: "Ruvanas Faith", ORGANISATIONS: "Ruvanas Organisations", CORRECTIONS: "Ruvanas Inside"
});
...
const ARTICLE_PRODUCTS = Object.freeze({
  ...
  "audio-uploads": ["RETAIL", "SCHOOL", "ONLINE", "HEALTH", "FAITH", "ORGANISATIONS"],
...
const PRODUCT_ARTICLES = Object.freeze({
  ...
  CORRECTIONS: [
    {
      id: "inside-foundation", category: "Getting started", title: "Prepare Ruvanas Inside safely",
      summary: "Your plan is recognised, but facility policy and private delivery are not live yet.",
      keywords: ["inside", "corrections", "facility", "private", "policy", "setup"],
      steps: [
        "Open Ruvanas Inside to review your account tier and foundation status.",
        "Discuss facility policy, staff approvals and private delivery with Ruvanas.",
        "Do not use a public player or ordinary station for a correctional facility.",
        "Wait for the guarded facility setup before adding sensitive material or starting playback."
      ]
    }
  ]
});
