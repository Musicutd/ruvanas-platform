...
const subscriberSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "simplePlaylists", href: "/dashboard/programming#workspace-simple", label: "Playlists & AutoDJ", description: "Start Non-Stop music, save playlists and schedule them on your channels.", entitlement: "serviceEnabled" },
  ...
  },
  {
    ...
    items: [
      { id: "studio", href: "/dashboard/studio", label: "Ruvanas Studio", description: "Create, edit, prepare and deliver audio from one workspace.", entitlement: "serviceEnabled" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "howItWorks", href: "/dashboard/how-it-works", label: "How it works", description: "Open one guided page for all six Ruvanas products.", topLevel: true },
