...
const subscriberSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "podcasts", href: "/dashboard/podcasts", label: "Podcasts", description: "Create series, publish episodes and share protected listening.", products: ["ONLINE", "HEALTH", "FAITH"] },
      ...
      { id: "locations", href: "/dashboard/locations", label: "Locations & zones", description: "Create physical sites and the playback or display areas inside them.", products: ["RETAIL", "SCHOOL", "HEALTH", "FAITH"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "listenerAnalytics", href: "/dashboard/listener-analytics", label: "Listener analytics", description: "Review privacy-safe audience sessions, listening time and channel trends.", products: ["ONLINE", "HEALTH", "FAITH"] },
      ...
      { id: "howItWorks", href: "/dashboard/how-it-works", label: "How it works", description: "Open one guided page for all five Ruvanas products.", topLevel: true },
