...
const subscriberSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "locations", href: "/dashboard/locations", label: "Locations & zones", description: "Create physical sites and the playback or display areas inside them.", products: ["RETAIL", "SCHOOL"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "howItWorks", href: "/dashboard/how-it-works", label: "How it works", description: "Open one guided page for Retail, School and Online Radio.", topLevel: true },
