...
const subscriberSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "retailMusic", href: "/dashboard/retail/music", label: "Music for shops", description: "Choose a listening area, approved music and playback hours.", products: ["RETAIL"] },
      { id: "programming", href: "/dashboard/programming", label: "Programming", description: "Plan approved music modes for every listening area.", entitlement: "serviceEnabled", products: ["RETAIL", "SCHOOL", "ONLINE", "HEALTH", "FAITH", "ORGANISATIONS"] },
      { id: "simplePlaylists", href: "/dashboard/programming#workspace-simple", label: "Playlists & AutoDJ", description: "Start Non-Stop music, save playlists and schedule them on your channels.", entitlement: "serviceEnabled", products: ["RETAIL", "SCHOOL", "ONLINE", "HEALTH", "FAITH", "ORGANISATIONS"] },
      { id: "podcasts", href: "/dashboard/podcasts", label: "Podcasts", description: "Create series, publish episodes and share protected listening.", products: ["ONLINE", "HEALTH", "FAITH", "ORGANISATIONS"] },
      ...
      { id: "media", href: "/dashboard/media", label: "Media library", description: "Upload and organise your organisation's audio.", products: ["RETAIL", "SCHOOL", "ONLINE", "HEALTH", "FAITH", "ORGANISATIONS"] },
      { id: "locations", href: "/dashboard/locations", label: "Locations & zones", description: "Create physical sites and the playback or display areas inside them.", products: ["RETAIL", "SCHOOL", "HEALTH", "FAITH", "ORGANISATIONS"] },
      { id: "players", href: "/dashboard/players", label: "Players & devices", description: "Prepare and check the secure players connected to your service.", products: ["RETAIL", "SCHOOL", "HEALTH", "FAITH", "ORGANISATIONS"] },
      { id: "sessions", href: "/dashboard/player-sessions", label: "Live streams", description: "See which players are currently using your stream allowance.", products: ["RETAIL", "SCHOOL", "ONLINE", "HEALTH", "FAITH", "ORGANISATIONS"] }
    ]
  },
  {
    id: "services",
    ...
    items: [
      { id: "studio", href: "/dashboard/studio", label: "Ruvanas Studio", description: "Create, edit, prepare and deliver audio from one workspace.", entitlement: "serviceEnabled", products: ["RETAIL", "SCHOOL", "ONLINE", "HEALTH", "FAITH", "ORGANISATIONS"] },
      ...
      { id: "retail", href: "/dashboard/retail-media", label: "Retail Media", description: "Coordinate approved commercial media campaigns.", entitlement: "retailMediaEnabled", products: ["RETAIL"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "listenerAnalytics", href: "/dashboard/listener-analytics", label: "Listener analytics", description: "Review privacy-safe audience sessions, listening time and channel trends.", products: ["ONLINE", "HEALTH", "FAITH", "ORGANISATIONS"] },
      ...
      { id: "howItWorks", href: "/dashboard/how-it-works", label: "How it works", description: "Open a guided page for Ruvanas products.", topLevel: true },
...
const adminSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/partner-demos", label: "Partner demos", superAdminOnly: true },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/music-distributors", label: "Music distributors", superAdminOnly: true },
      { href: "/admin/promo-only", label: "Promo Only testing", superAdminOnly: true },
      ...
      { href: "/admin/test-data-reset", label: "Test data reset", superAdminOnly: true },
