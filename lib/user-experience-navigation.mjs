...
const subscriberSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "publicPlayer", label: "Public player", description: "Publish the branded listener page and website embed." },
      { id: "stationWebsite", label: "Station website & mobile", description: "Publish the installable station home, now-playing, podcasts and custom domain." },
      { id: "stationNetworks", href: "/dashboard/radio/networks", label: "Station networks", description: "Manage explicit station memberships across independently owned radio organisations.", entitlement: "serviceEnabled" },
      { id: "syndication", href: "/dashboard/radio/syndication", label: "Programme syndication", description: "Share recorded programmes and live relays through rights-controlled network agreements.", entitlement: "serviceEnabled" },
      { id: "radioAdvertising", href: "/dashboard/radio/advertising", label: "Radio advertising", description: "Control commercial break limits, placement readiness and completed-play evidence.", entitlement: "retailMediaEnabled" },
      { id: "rightsRoyalty", href: "/dashboard/radio/rights-reporting", label: "Rights & royalty reports", description: "Map recognised music identifiers and create attested authority-specific usage exports.", entitlement: "serviceEnabled" },
      { id: "distribution", href: "/dashboard/radio/distribution", label: "Station distribution", description: "Connect approved directories, streaming/CDN partners, apps and voice assistants.", entitlement: "serviceEnabled" },
      { id: "programmeDirector", href: "/dashboard/radio/programme-director", label: "AI Programme Director", description: "Prepare explainable, human-approved programme recommendations without changing live radio.", entitlement: "serviceEnabled" },
      { id: "newsroom", href: "/dashboard/radio/newsroom", label: "Newsroom", description: "Manage assigned stories, fact-check evidence, production and editorial release.", entitlement: "serviceEnabled" },
      ...
      { id: "podcasts", href: "/dashboard/podcasts", label: "Podcasts", description: "Create station series, publish episodes and share an RSS feed.", entitlement: "serviceEnabled" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "listenerAnalytics", href: "/dashboard/listener-analytics", label: "Listener analytics", description: "Review privacy-safe audience sessions, listening time and channel trends.", entitlement: "serviceEnabled" },
