const subscriberSections = [
  ...
  },
  {
    ...
    items: [
      { id: "programming", href: "/dashboard/programming", label: "Radio programming", description: "Choose approved music modes and plan the week for each listening area.", entitlement: "serviceEnabled" },
      { id: "promotions", href: "/dashboard/promotions", label: "Promotions planner", description: "Schedule approved promotional audio and preview its expected delivery.", entitlement: "serviceEnabled" },
