...
export const PRODUCT_QA_PROFILES = Object.freeze([
  ...
  Object.freeze({
    product: "HEALTH",
    organisationName: "Ruvanas Health QA",
    startingPlanCode: "HEALTH_PRO",
    landingRoute: "/dashboard/health"
  }),
  Object.freeze({
    product: "FAITH",
    organisationName: "Ruvanas Faith QA",
    startingPlanCode: "FAITH_PRO",
    landingRoute: "/dashboard/faith"
  }),
  Object.freeze({
    product: "ORGANISATIONS",
    organisationName: "Ruvanas Organisations QA",
    startingPlanCode: "ORGANISATIONS_PRO",
    landingRoute: "/dashboard/organisations"
  }),
  Object.freeze({
    product: "CORRECTIONS",
    organisationName: "Ruvanas Inside QA",
    startingPlanCode: "CORRECTIONS_REHABILITATION_PRO",
    landingRoute: "/dashboard/corrections"
  })
]);
...
export function productQaSwitchDecision({ organisation, planCode } = {}) {
  ...
  if (!profile) {
    return { ok: false, status: 409, code: "NOT_QA_ORGANISATION", error: "Tier testing is limited to the designated Ruvanas QA organisations." };
  }
...
export function validateProductQaPolicy() {
  if (PRODUCT_QA_PROFILES.length !== 7) throw new Error("Exactly seven product QA profiles are required.");
