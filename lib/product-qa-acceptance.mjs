...
export function productQaSwitchDecision({ organisation, planCode } = {}) {
  ...
  if (!profile) {
    return { ok: false, status: 409, code: "NOT_QA_ORGANISATION", error: "Tier testing is limited to the five designated Ruvanas QA organisations." };
  }
...
export function validateProductQaPolicy() {
  if (PRODUCT_QA_PROFILES.length !== 5) throw new Error("Exactly five product QA profiles are required.");
