...
export function productQaSwitchDecision({ organisation, planCode } = {}) {
  ...
  if (!profile) {
    return { ok: false, status: 409, code: "NOT_QA_ORGANISATION", error: "Tier testing is limited to the six designated Ruvanas QA organisations." };
  }
...
export function validateProductQaPolicy() {
  if (PRODUCT_QA_PROFILES.length !== 6) throw new Error("Exactly six product QA profiles are required.");
