...
async function clearDigitalSignageAssetReferences(tx, organisationIds) {
  ...
  return playlistItems.count + retailVisualCreatives.count;
}
  ...
  return database.$transaction(async (tx) => {
    ...
    return {
      ...
      deletedRelatedRecords:
        ...
        betaProgrammeReviews.count + betaProgrammes.count + digitalSignageAssetReferences + orderedTenantRecords
    };
