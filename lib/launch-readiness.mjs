...
export const LAUNCH_OPERATOR_CHECKS = Object.freeze([
  Object.freeze({
    ...
    description: "Confirm the release commit passed every required GitHub check, including the final Retail, School and Online Radio acceptance gate."
  }),
  Object.freeze({
    id: "PRODUCT_REGISTRATION_ACCEPTANCE_PASSED",
    label: "Product registration matrix accepted",
    description: "Confirm the three controlled QA organisations passed product isolation, correct login routing and all fifteen Tier 1–5 plan and Licensed Music Catalogue combinations, with no billing events."
  }),
  Object.freeze({
