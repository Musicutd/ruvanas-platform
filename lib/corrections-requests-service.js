...
export async function assertEligibleTrack(tx, request, facility, entitlements, trackId, instant = new Date()) {
  ...
  const eligibility = correctionsMusicEligibility(track, { organisationId: request.organisationId, facility, organisationPolicy, facilityPolicy: facility, licensedCatalogueLevel: entitlements.licensedMusicCatalogueLevel, configuredGenres, instant });
