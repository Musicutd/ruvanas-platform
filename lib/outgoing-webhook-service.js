...
export async function processOutgoingWebhookBatch(prisma, { limit = 20, fetchImpl = fetch, deliver = deliverWebhookEvent } = {}) {
  const now = new Date();
  ...
  return { claimed, delivered, failed, abandoned };
}
