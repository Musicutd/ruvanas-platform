...
export function resolveEntitlements(subscription, now = new Date()) {
  ...
  const correctionsRadioEnabled = Boolean(
    serviceEnabled &&
    (complimentaryAccess
      ? plan?.correctionsRadioEnabled
      : subscription?.correctionsRadioEnabled ?? plan?.correctionsRadioEnabled)
  );
  ...
  const digitalSignageEnabled = Boolean(
    serviceEnabled &&
    (complimentaryAccess
  ...
  return Object.freeze({
    ...
    digitalSignageDisplayLimit: retailRadioEnabled && digitalSignageEnabled ? plan.stationLimit : null,
    productAccessSource: Object.freeze({
      ...
      corrections: capabilitySource(subscription, "correctionsRadioEnabled", complimentaryAccess),
