...
export function publicWebhookPayload(eventType, input) {
  const allowed = {
    ...
    "distribution.destination.sync": ["operation", "destinationId", "destinationKind", "providerKey", "revision", "stationName", "stationSlug", "stationUrl", "playerUrl", "channelName", "territoryCodes", "languageCodes", "categories", "policyVersion"]
  }[eventType];
