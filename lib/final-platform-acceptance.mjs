...
export const FINAL_PLATFORM_ACCEPTANCE_STEPS = Object.freeze([
  Object.freeze({
    id: "product-registration-policy",
    label: "Product registration, entitlement, routing and QA policy",
    command: "test:product-registration"
  }),
  Object.freeze({
    id: "three-product-integration",
    label: "Retail, School and Online Radio integration journeys",
    command: "test:integration"
  }),
  Object.freeze({
    id: "organisations-release-policy",
    label: "Ruvanas Organisations authority, isolation, workflows and release boundaries",
    command: "test:organisations"
  }),
  Object.freeze({
  ...
  Object.freeze({
    id: "enterprise-scale-policy",
    label: "Enterprise isolation and scale policy",
    command: "test:enterprise-scale"
  })
]);
