...
const catalogueMetadataSchema = z.object({
  ...
  permittedUses: z.array(z.enum(["RETAIL_RADIO", "SCHOOL_RADIO", "ONLINE_RADIO", "HEALTH_RADIO", "FAITH_RADIO"])).min(1, "Choose at least one Ruvanas service permitted by the licence."),
