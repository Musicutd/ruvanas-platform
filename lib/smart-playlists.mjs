...
const playlistSchema = z.object({
  ...
  rightsUse: z.enum(["RETAIL_RADIO", "SCHOOL_RADIO", "ONLINE_RADIO", "HEALTH_RADIO", "FAITH_RADIO", "ORGANISATIONS_RADIO"]).default("ONLINE_RADIO"),
...
export function evaluateSmartPlaylistCandidates(tracks, playlist, instant = new Date(), licensedCatalogueLevel = null) {
