export const SUBSCRIBER_PRODUCTS = Object.freeze({
  ...
  CORRECTIONS: Object.freeze({
    key: "CORRECTIONS",
    id: "correctionsHome",
    capability: "correctionsRadioEnabled",
    href: "/dashboard/corrections",
    label: "Ruvanas Inside",
    description: "Prepare governed, private media for correctional facilities.",
    symbol: "CORRECTIONS"
  })
});
...
export function subscriberProductForStationFamily(productFamily) {
  ...
  if (productFamily === "CORRECTIONS") return "CORRECTIONS";
  return "ONLINE";
}
