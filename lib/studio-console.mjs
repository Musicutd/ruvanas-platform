...
export const STUDIO_CONSOLE_LAYOUTS = Object.freeze({
  PRESENTER: ["ON_AIR", "LIVE_PLAYLIST", "DAILY_LOG", "CARTS", "MIC", "OUTPUT_HEALTH"],
  PRODUCER: ["ON_AIR", "LIVE_PLAYLIST", "PREPARE", "LIBRARY", "DAILY_LOG", "NOTES", "OUTPUT_HEALTH"],
  AUTOMATION: ["ON_AIR", "DAILY_LOG", "RADIO_CLOCKS", "FALLBACK", "OUTPUT_HEALTH"],
  COMPACT: ["ON_AIR", "LIVE_PLAYLIST", "CARTS", "MIC", "OUTPUT_HEALTH"],
  DUAL_SCREEN: ["ON_AIR", "LIVE_PLAYLIST", "CARTS", "MIC", "OUTPUT_HEALTH", "LIBRARY", "PREPARE", "DAILY_LOG", "RADIO_CLOCKS"]
});
