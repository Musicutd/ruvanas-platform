export const interfaceMessages = Object.freeze({
  ...
  notifications: {
    ...
    emptyDescription: "New playback, account, content, production and School Radio updates will appear here."
  },
  analytics: {
  ...
  playerSessions: {
    title: "Active player streams",
    emptyTitle: "No active player streams",
