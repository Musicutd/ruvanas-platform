...
test("manifest exposes safe same-origin media URLs without storage keys",()=>{
  const manifest=buildPlayerManifest({player,resolution,instant:new Date("2026-08-31T10:02:00.000Z")});
...
test("unavailable catalogue entries are removed from a manifest",()=>{
  ...
  const manifest=buildPlayerManifest({player,resolution:unsafe,instant:new Date("2026-08-31T10:02:00.000Z")});
...
test("closed and unscheduled players receive an empty plan",()=>{
  const manifest=buildPlayerManifest({player,resolution:{reason:"LOCATION_CLOSED",musicMode:null},instant:new Date("2026-08-31T10:02:00.000Z")});
