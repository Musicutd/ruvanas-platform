...
test("a published clock adapts its current music item and bounds the next decision", () => {
  ...
  }, occurrence, instant, organisationId, { licensedCatalogueLevel: "FOCUSED" });
...
test("an approved rundown adapts its current music track and protects School priority", () => {
  ...
  const direct = currentRundownMode(rundown, occurrence, instant, organisationId, { licensedCatalogueLevel: "FOCUSED" });
  ...
  const candidates = advancedProgrammeCandidates(schedule, instant, organisationId, channelId, { licensedCatalogueLevel: "FOCUSED" });
...
test("AutoDJ adapters expose default and backup independently", () => {
  ...
  }, { organisationId, channelId, instant, locationOpen: true, local: { date: "2026-09-07" }, licensedCatalogueLevel: "FOCUSED" });
