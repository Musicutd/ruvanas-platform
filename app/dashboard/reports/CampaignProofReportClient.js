...
const styles = {
  page: { minHeight: "100vh", background: "var(--rv-page-bg)", color: "var(--rv-text)", padding: "40px max(20px, calc((100% - 1160px) / 2)) 72px", fontFamily: "Arial, sans-serif" },
  header: { display: "flex", justifyContent: "space-between", gap: 24, alignItems: "end", flexWrap: "wrap" },
  back: { color: "var(--rv-text-muted)", textDecoration: "none", fontWeight: 700 },
  ...
  subtitle: { color: "var(--rv-text-muted)", lineHeight: 1.6, fontSize: 17, margin: "14px 0 0" },
  notice: { marginTop: 24, padding: 16, border: "1px solid #6b5729", borderRadius: 10, background: "var(--rv-warning-bg)", color: "var(--rv-warning-text)", lineHeight: 1.5 },
  filters: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 12, marginTop: 18, padding: 18, border: "1px solid var(--rv-border)", borderRadius: 12, background: "var(--rv-surface)", alignItems: "end" },
  label: { display: "grid", gap: 7, color: "var(--rv-text)", fontSize: 12, fontWeight: 800 },
  input: { width: "100%", boxSizing: "border-box", border: "1px solid var(--rv-border)", borderRadius: 7, background: "var(--rv-input-bg)", color: "var(--rv-input-text)", padding: "10px 9px" },
  ...
  metric: { border: "1px solid var(--rv-border)", borderRadius: 12, padding: 18, background: "var(--rv-surface)", display: "grid", gap: 8 },
  metricWarning: { borderColor: "#9f4b4b", background: "var(--rv-error-bg)" },
  metricLabel: { color: "var(--rv-text-muted)", fontSize: 12, fontWeight: 800, textTransform: "uppercase", letterSpacing: 0.6 },
  metricValue: { fontSize: 29 },
  card: { marginTop: 20, border: "1px solid var(--rv-border)", borderRadius: 12, padding: 20, background: "var(--rv-surface)" },
  sectionTitle: { margin: "0 0 16px", fontSize: 22 },
  table: { width: "100%", minWidth: 980, borderCollapse: "collapse" },
  th: { textAlign: "left", padding: 10, borderBottom: "2px solid var(--rv-border)", color: "var(--rv-text-muted)", fontSize: 12 },
  td: { padding: 10, borderBottom: "1px solid var(--rv-border)", color: "var(--rv-text)", verticalAlign: "top" },
  tdStrong: { padding: 10, borderBottom: "1px solid var(--rv-border)", color: "var(--rv-text)", fontWeight: 800, verticalAlign: "top" },
  number: { padding: 10, borderBottom: "1px solid #2b3a54", textAlign: "right", fontVariantNumeric: "tabular-nums" },
  detail: { display: "block", marginTop: 4, color: "var(--rv-text-muted)", fontWeight: 500 },
  muted: { color: "var(--rv-text-muted)" },
  status: { color: "var(--rv-success-text)", margin: "14px 0 0" },
  error: { color: "var(--rv-error-text)", background: "var(--rv-error-bg)", border: "1px solid #9f4b4b", borderRadius: 8, padding: 12, margin: "14px 0 0" }
};
