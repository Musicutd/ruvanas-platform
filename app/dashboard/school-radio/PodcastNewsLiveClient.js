...
const styles = {
  ...
  muted: { color: "var(--rv-text-muted)", lineHeight: 1.5, margin: "6px 0" }, warning: { color: "var(--rv-warning-text)", borderLeft: "3px solid #fb923c", paddingLeft: 10, lineHeight: 1.5 },
  columns: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 14 }, list: { display: "grid", gap: 14, marginTop: 14 },
  card: { border: "1px solid var(--rv-border)", borderRadius: 12, background: "var(--rv-surface)", padding: 17 }, row: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 },
  label: { display: "grid", gap: 6, marginBottom: 11, color: "var(--rv-text)", fontWeight: 800, fontSize: 13 }, check: { display: "flex", alignItems: "center", gap: 8, color: "var(--rv-text)", margin: "10px 0", fontWeight: 800, fontSize: 13 },
  input: { width: "100%", boxSizing: "border-box", border: "1px solid var(--rv-border)", borderRadius: 8, background: "var(--rv-input-bg)", color: "var(--rv-input-text)", padding: "10px 11px", font: "inherit" }, textarea: { width: "100%", minHeight: 76, boxSizing: "border-box", border: "1px solid var(--rv-border)", borderRadius: 8, background: "var(--rv-input-bg)", color: "var(--rv-input-text)", padding: 10, font: "inherit" }, editor: { width: "100%", minHeight: 130, boxSizing: "border-box", border: "1px solid var(--rv-border)", borderRadius: 8, background: "var(--rv-surface)", color: "#111827", padding: 10, fontFamily: "ui-monospace, monospace", fontSize: 12 },
  actions: { display: "flex", flexWrap: "wrap", gap: 8, alignItems: "center", marginTop: 10 }, primary: { border: 0, borderRadius: 8, background: "#f4b942", color: "#101827", padding: "10px 13px", fontWeight: 900, cursor: "pointer" }, approve: { border: 0, borderRadius: 8, background: "#22c55e", color: "#052e16", padding: "10px 13px", fontWeight: 900, cursor: "pointer" }, secondary: { border: "1px solid var(--rv-border)", borderRadius: 8, background: "transparent", color: "var(--rv-text)", padding: "9px 12px", fontWeight: 800, cursor: "pointer" }, danger: { border: "1px solid #f87171", borderRadius: 8, background: "transparent", color: "var(--rv-error-text)", padding: "9px 12px", fontWeight: 800, cursor: "pointer" },
  publicLink: { border: "1px solid #60a5fa", borderRadius: 8, color: "var(--rv-info-text)", padding: "9px 12px", fontWeight: 800, textDecoration: "none" }, audit: { color: "#93a4bb", fontSize: 12, margin: "12px 0 0" },
  badge: { display: "inline-block", borderRadius: 6, background: "var(--rv-surface)", color: "#f8d78a", padding: "5px 8px", fontSize: 11, fontWeight: 900, whiteSpace: "nowrap" }, divider: { height: 1, background: "var(--rv-surface)", margin: "26px 0" },
  error: { border: "1px solid #ef4444", background: "var(--rv-error-bg)", color: "var(--rv-error-text)", borderRadius: 8, padding: 12, marginBottom: 14 }, notice: { border: "1px solid #22c55e", background: "var(--rv-success-bg)", color: "var(--rv-success-text)", borderRadius: 8, padding: 12, marginBottom: 14 }
};
