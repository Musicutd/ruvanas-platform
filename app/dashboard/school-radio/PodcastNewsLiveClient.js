...
export default function PodcastNewsLiveClient() {
  ...
  return <section style={styles.shell}>
    <div style={styles.heading}><div><p style={styles.eyebrow}>STAGE 4G · PODCAST · NEWSROOM · LIVE STUDIO</p><h2 style={styles.title}>Publish stories and supervise live radio</h2><p style={styles.muted}>Approved audio stays in Ruvanas. Public publishing remains locked; live sessions require teacher control and approved fallback audio.</p></div><Badge value="STAFF SUPERVISED" /></div>
