...
const styles = {
  section: { border: "1px solid var(--rv-border)", borderRadius: 16, background: "var(--rv-surface)", padding: 22, marginBottom: 24 },
  ...
  title: { margin: "0 0 8px", fontSize: 26 }, muted: { color: "var(--rv-text-muted)", lineHeight: 1.55, margin: 0 },
  ...
  lock: { border: "1px solid var(--rv-border)", borderRadius: 10, background: "var(--rv-surface)", padding: 12, display: "grid", gap: 5, color: "var(--rv-text)", fontSize: 13 },
  ...
  card: { border: "1px solid var(--rv-border)", borderRadius: 12, background: "var(--rv-surface)", padding: 17, marginBottom: 14 }, cardTitle: { margin: "0 0 15px" },
  label: { display: "grid", gap: 7, marginBottom: 12, color: "var(--rv-text)", fontWeight: 800, fontSize: 13 },
  input: { width: "100%", boxSizing: "border-box", border: "1px solid var(--rv-border)", borderRadius: 8, background: "var(--rv-input-bg)", color: "var(--rv-input-text)", padding: "10px 11px", font: "inherit" },
  textarea: { width: "100%", minHeight: 82, boxSizing: "border-box", border: "1px solid var(--rv-border)", borderRadius: 8, background: "var(--rv-input-bg)", color: "var(--rv-input-text)", padding: "10px 11px", font: "inherit" },
  check: { display: "flex", gap: 10, alignItems: "flex-start", color: "var(--rv-text)", lineHeight: 1.45, marginBottom: 10 },
  gaps: { color: "var(--rv-warning-text)", borderLeft: "3px solid #fb923c", paddingLeft: 12, marginTop: 15, lineHeight: 1.5 }, ready: { color: "var(--rv-success-text)", marginTop: 15 },
  ...
  secondary: { border: "1px solid var(--rv-border)", borderRadius: 8, background: "transparent", color: "var(--rv-text)", padding: "10px 14px", fontWeight: 800, cursor: "pointer" },
  error: { border: "1px solid #ef4444", background: "var(--rv-error-bg)", color: "var(--rv-error-text)", borderRadius: 8, padding: 11, marginBottom: 14 },
  notice: { border: "1px solid #22c55e", background: "var(--rv-success-bg)", color: "var(--rv-success-text)", borderRadius: 8, padding: 11, marginBottom: 14 },
  reviewNotice: { border: "1px solid #60a5fa", background: "var(--rv-info-bg)", color: "var(--rv-info-text)", borderRadius: 8, padding: 11, marginBottom: 14 },
  reviewDecision: { display: "grid", gap: 5, border: "1px solid var(--rv-border)", background: "var(--rv-surface)", color: "var(--rv-text)", borderRadius: 8, padding: 12, marginBottom: 14, fontSize: 13 },
  privacy: { color: "var(--rv-text-muted)", fontSize: 12, margin: "6px 0 0" }
};
