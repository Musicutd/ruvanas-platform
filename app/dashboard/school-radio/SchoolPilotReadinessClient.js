...
const styles = {
  ...
  status: { borderRadius: 999, padding: "7px 11px", fontSize: 11, fontWeight: 900, whiteSpace: "nowrap" }, ready: { background: "var(--rv-success-bg)", color: "#166534" }, blocked: { background: "var(--rv-error-bg)", color: "#991b1b" }, progress: { background: "var(--rv-warning-bg)", color: "#92400e" },
  safety: { margin: "16px 0", border: "1px solid #f4b942", borderRadius: 10, padding: 13, background: "var(--rv-warning-bg)", color: "var(--rv-warning-text)", lineHeight: 1.5 },
  metrics: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 12, marginBottom: 12 }, metric: { display: "grid", gap: 6, border: "1px solid var(--rv-border)", borderRadius: 10, padding: 15, background: "var(--rv-surface)" }, metricValue: { color: "#f4b942", fontWeight: 900, fontSize: 26 },
  columns: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 12, marginBottom: 12 }, card: { border: "1px solid var(--rv-border)", borderRadius: 10, padding: 15, background: "var(--rv-surface)" }, cardTitle: { margin: "0 0 8px" },
  check: { display: "flex", gap: 10, alignItems: "flex-start", padding: "10px 0", borderTop: "1px solid #2b3a54" }, label: { display: "grid", gap: 6, margin: "11px 0", color: "var(--rv-text)", fontWeight: 800, fontSize: 12 }, input: { border: "1px solid var(--rv-border)", borderRadius: 8, padding: "9px 10px", font: "inherit" },
  gaps: { display: "grid", gap: 5, border: "1px solid #7f1d1d", background: "var(--rv-error-bg)", color: "var(--rv-error-text)", borderRadius: 8, padding: 11, margin: "12px 0" }, primary: { border: 0, borderRadius: 8, background: "#f4b942", color: "#101827", padding: "10px 13px", fontWeight: 900, cursor: "pointer" }, secondary: { border: "1px solid #60a5fa", borderRadius: 8, background: "transparent", color: "var(--rv-info-text)", padding: "9px 12px", fontWeight: 800, cursor: "pointer" },
  hold: { display: "flex", justifyContent: "space-between", gap: 14, alignItems: "center", borderTop: "1px solid #34445f", padding: "13px 0" }, holdReason: { color: "var(--rv-text)", margin: "5px 0" }, release: { border: "1px solid #fca5a5", borderRadius: 8, background: "transparent", color: "var(--rv-error-text)", padding: "8px 10px", fontWeight: 800, cursor: "pointer" }, error: { border: "1px solid #ef4444", background: "var(--rv-error-bg)", color: "var(--rv-error-text)", borderRadius: 8, padding: 12, margin: "12px 0" }, notice: { border: "1px solid #22c55e", background: "var(--rv-success-bg)", color: "var(--rv-success-text)", borderRadius: 8, padding: 12, margin: "12px 0" }
};
