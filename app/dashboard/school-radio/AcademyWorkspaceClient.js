...
const styles = {
  workspace: { border: "1px solid #395071", borderRadius: 16, background: "var(--rv-surface)", padding: 22, marginBottom: 20 },
  ...
  hint: { color: "var(--rv-text-muted)", lineHeight: 1.5, fontSize: 13, margin: "6px 0" },
  badge: { border: "1px solid #60a5fa", borderRadius: 999, color: "var(--rv-info-text)", padding: "6px 10px", fontSize: 11, fontWeight: 900 },
  activeBadge: { color: "var(--rv-success-text)", background: "var(--rv-success-bg)", borderRadius: 6, padding: "5px 8px", fontSize: 11, fontWeight: 900 },
  pausedBadge: { color: "var(--rv-text)", background: "var(--rv-surface)", borderRadius: 6, padding: "5px 8px", fontSize: 11, fontWeight: 900 },
  ...
  metric: { background: "var(--rv-surface)", borderRadius: 8, padding: "9px 6px", textAlign: "center" },
  metricValue: { display: "block", fontSize: 18, color: "var(--rv-text)" }, metricLabel: { display: "block", color: "var(--rv-text-muted)", fontSize: 10, marginTop: 3 },
  label: { display: "grid", gap: 7, marginBottom: 13, color: "var(--rv-text)", fontWeight: 800, fontSize: 13 },
  ...
  secondary: { border: "1px solid var(--rv-border)", borderRadius: 8, background: "transparent", color: "var(--rv-text)", padding: "9px 12px", fontWeight: 800, cursor: "pointer" },
  restricted: { color: "var(--rv-warning-text)", fontSize: 12, fontWeight: 800 },
  ...
  safety: { color: "var(--rv-text-muted)", fontSize: 12, margin: "18px 0 0" }
};
