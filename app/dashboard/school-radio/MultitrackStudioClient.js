...
const s = {
  zoom: { display: "flex", gap: 8, alignItems: "center", color: "#dce5f3", fontSize: 12, fontWeight: 800 },
  timelineHelp: { margin: "0 0 12px", color: "#b8c5d8", fontSize: 13, lineHeight: 1.5 },
  laneScroll: { overflowX: "auto", border: "1px solid #34445f", borderRadius: 9, background: "#091426", marginBottom: 10 },
  ...
  ruler: { position: "absolute", inset: "0 0 auto 0", height: 24, borderBottom: "1px solid #334155", color: "#8ea0b8", fontSize: 10 },
