...
const styles = {
  card: { border: "1px solid var(--rv-border)", borderRadius: 14, background: "var(--rv-surface)", padding: 22, marginBottom: 20, color: "var(--rv-text)" },
  eyebrow: { color: "#f4b942", fontSize: 12, fontWeight: 900, letterSpacing: 1.2, margin: "0 0 8px" },
  title: { margin: "0 0 10px" },
  body: { color: "var(--rv-text)", lineHeight: 1.55, maxWidth: 850 },
  ready: { border: "1px solid #22c55e", background: "var(--rv-success-bg)", color: "var(--rv-success-text)", borderRadius: 8, padding: 11, margin: "14px 0" },
  blocked: { border: "1px solid #f59e0b", background: "var(--rv-warning-bg)", color: "var(--rv-warning-text)", borderRadius: 8, padding: 11, margin: "14px 0" },
  error: { border: "1px solid #ef4444", background: "var(--rv-error-bg)", color: "var(--rv-error-text)", borderRadius: 8, padding: 11, margin: "12px 0" },
  notice: { border: "1px solid #22c55e", background: "var(--rv-success-bg)", color: "var(--rv-success-text)", borderRadius: 8, padding: 11, margin: "12px 0" },
  ...
  item: { border: "1px solid var(--rv-border)", borderRadius: 10, padding: 15, background: "var(--rv-surface)" },
  row: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 },
  hint: { color: "var(--rv-text-muted)", fontSize: 13, lineHeight: 1.45, margin: "6px 0" },
  badge: { borderRadius: 5, background: "var(--rv-info-bg)", color: "#1e40af", padding: "4px 7px", fontSize: 10, fontWeight: 900, whiteSpace: "nowrap" },
  ...
  secondary: { border: "1px solid var(--rv-border)", borderRadius: 8, background: "transparent", color: "var(--rv-text)", padding: "9px 12px", fontWeight: 800, cursor: "pointer", justifySelf: "start" },
  danger: { border: 0, background: "transparent", color: "var(--rv-error-text)", padding: "9px 0 0", fontWeight: 800, cursor: "pointer" },
  safety: { color: "var(--rv-text-muted)", fontSize: 12, lineHeight: 1.5, margin: "18px 0 0" }
};
