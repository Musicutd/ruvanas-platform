...
const s = {
  panel: { border: "1px solid var(--rv-border)", borderRadius: 16, background: "var(--rv-surface)", padding: 22, marginBottom: 24 }, heading: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16 }, eyebrow: { color: "#f4b942", fontSize: 11, fontWeight: 900, letterSpacing: 1.1, margin: "0 0 7px" }, title: { margin: "0 0 8px", fontSize: 28 }, cardTitle: { margin: "0 0 12px" }, hint: { color: "var(--rv-text-muted)", lineHeight: 1.5, fontSize: 13 }, topGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 14, marginTop: 18 }, card: { border: "1px solid var(--rv-border)", borderRadius: 12, padding: 16, background: "var(--rv-surface)" }, formGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: 12 }, label: { display: "grid", gap: 6, color: "var(--rv-text)", fontWeight: 800, fontSize: 12 }, input: { width: "100%", boxSizing: "border-box", border: "1px solid var(--rv-border)", borderRadius: 7, background: "var(--rv-input-bg)", color: "var(--rv-input-text)", padding: "10px 11px", font: "inherit" }, primary: { border: 0, borderRadius: 8, background: "#f4b942", color: "#101827", padding: "11px 15px", fontWeight: 900, cursor: "pointer" }, secondary: { border: "1px solid var(--rv-border)", borderRadius: 8, background: "transparent", color: "var(--rv-text)", padding: "10px 13px", fontWeight: 800, cursor: "pointer" }, linkButton: { border: 0, background: "none", color: "#f4b942", fontWeight: 800, cursor: "pointer" }, badge: { borderRadius: 5, padding: "5px 8px", fontSize: 10, fontWeight: 900, whiteSpace: "nowrap" }, meta: { color: "var(--rv-text-muted)", fontSize: 12 }, warning: { color: "var(--rv-warning-text)", fontWeight: 500 }, review: { color: "var(--rv-warning-text)", borderLeft: "3px solid #fb923c", paddingLeft: 10 }, list: { display: "grid", gap: 9 }, row: { display: "grid", gridTemplateColumns: "32px 1fr", gap: 10, padding: 12, border: "1px solid var(--rv-border)", borderRadius: 9, background: "var(--rv-surface-muted)" }, position: { width: 28, height: 28, borderRadius: 14, display: "grid", placeItems: "center", background: "var(--rv-surface)", color: "#f4b942", fontWeight: 900 }, itemBody: { minWidth: 0 }, itemHead: { display: "flex", justifyContent: "space-between", gap: 10 }, actions: { display: "flex", gap: 5, flexWrap: "wrap" }, icon: { border: "1px solid var(--rv-border)", borderRadius: 5, background: "transparent", color: "var(--rv-text)", cursor: "pointer" }, remove: { border: 0, background: "none", color: "var(--rv-error-text)", cursor: "pointer", fontWeight: 800 }, note: { color: "var(--rv-text)", fontSize: 13 }, audio: { width: "100%", marginTop: 8 }, preview: { marginTop: 10, padding: 10, display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(170px,1fr))", gap: 8, border: "1px solid var(--rv-border)", borderRadius: 8 }, previewTitle: { gridColumn: "1/-1", color: "#f4b942", fontSize: 11, fontWeight: 900 }, reviewActions: { display: "flex", flexWrap: "wrap", gap: 8, marginTop: 14 }, approve: { border: 0, borderRadius: 8, background: "#22c55e", color: "#052e16", padding: "11px 15px", fontWeight: 900, cursor: "pointer" }, error: { border: "1px solid #ef4444", background: "var(--rv-error-bg)", color: "var(--rv-error-text)", borderRadius: 8, padding: 10, marginTop: 12 }, notice: { border: "1px solid #22c55e", background: "var(--rv-success-bg)", color: "var(--rv-success-text)", borderRadius: 8, padding: 10, marginTop: 12 }, privacy: { color: "var(--rv-text-muted)", fontSize: 11, marginTop: 16 }
};
