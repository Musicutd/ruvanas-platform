...
const styles = {
  shell: { margin: "0 0 24px", border: "1px solid var(--rv-border)", borderRadius: 16, background: "var(--rv-surface)", padding: 22 }, header: { display: "flex", justifyContent: "space-between", gap: 18, alignItems: "flex-start" },
  eyebrow: { color: "#f4b942", fontSize: 12, fontWeight: 900, letterSpacing: 1.1, margin: "0 0 7px" }, title: { margin: "0 0 8px", fontSize: 28 }, muted: { color: "var(--rv-text-muted)", lineHeight: 1.5, margin: "6px 0" },
  status: { borderRadius: 999, padding: "7px 11px", fontSize: 11, fontWeight: 900, whiteSpace: "nowrap" }, safety: { margin: "16px 0", border: "1px solid #60a5fa", borderRadius: 10, padding: 13, background: "var(--rv-info-bg)", color: "var(--rv-info-text)", lineHeight: 1.5 },
  metrics: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 12, marginBottom: 12 }, metric: { display: "grid", gap: 6, border: "1px solid var(--rv-border)", borderRadius: 10, padding: 15, background: "var(--rv-surface)" }, metricValue: { color: "#f4b942", fontWeight: 900, fontSize: 22 },
  columns: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(320px,1fr))", gap: 12, marginBottom: 12 }, card: { border: "1px solid var(--rv-border)", borderRadius: 10, padding: 15, background: "var(--rv-surface)" }, cardTitle: { margin: "0 0 8px" }, two: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(170px,1fr))", gap: 10 },
  label: { display: "grid", gap: 6, margin: "11px 0", color: "var(--rv-text)", fontWeight: 800, fontSize: 12 }, input: { width: "100%", boxSizing: "border-box", border: "1px solid var(--rv-border)", borderRadius: 8, padding: "9px 10px", font: "inherit" },
  primary: { border: 0, borderRadius: 8, background: "#f4b942", color: "#101827", padding: "10px 13px", fontWeight: 900, cursor: "pointer" }, secondary: { border: "1px solid #60a5fa", borderRadius: 8, background: "transparent", color: "var(--rv-info-text)", padding: "9px 12px", fontWeight: 800, cursor: "pointer" },
  row: { display: "flex", justifyContent: "space-between", gap: 14, alignItems: "center", borderTop: "1px solid #34445f", padding: "13px 0" }, body: { color: "var(--rv-text)", margin: "5px 0", lineHeight: 1.45 }, reason: { color: "var(--rv-text-muted)", margin: "6px 0 0", whiteSpace: "pre-wrap", fontSize: 13 }, actions: { display: "flex", flexWrap: "wrap", gap: 7, justifyContent: "flex-end" },
  action: { border: "1px solid var(--rv-border)", borderRadius: 7, background: "transparent", color: "var(--rv-text)", padding: "7px 9px", fontWeight: 800, cursor: "pointer" }, resolve: { border: "1px solid #22c55e", borderRadius: 7, background: "transparent", color: "var(--rv-success-text)", padding: "7px 9px", fontWeight: 800, cursor: "pointer" }, danger: { border: "1px solid #f87171", borderRadius: 7, background: "transparent", color: "var(--rv-error-text)", padding: "7px 9px", fontWeight: 800, cursor: "pointer" },
  error: { border: "1px solid #ef4444", background: "var(--rv-error-bg)", color: "var(--rv-error-text)", borderRadius: 8, padding: 12, margin: "12px 0" }, notice: { border: "1px solid #22c55e", background: "var(--rv-success-bg)", color: "var(--rv-success-text)", borderRadius: 8, padding: 12, margin: "12px 0" }
};
