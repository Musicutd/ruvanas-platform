...
const styles = {
  shell: { margin: "0 0 24px", border: "1px solid var(--rv-border)", borderRadius: 16, background: "var(--rv-surface)", padding: 22 }, row: { display: "flex", justifyContent: "space-between", gap: 18, alignItems: "flex-start" },
  ...
  enabled: { background: "var(--rv-success-bg)", color: "#166534", borderRadius: 6, padding: "6px 9px", fontSize: 11, fontWeight: 900 }, private: { background: "var(--rv-surface)", color: "var(--rv-text)", borderRadius: 6, padding: "6px 9px", fontSize: 11, fontWeight: 900 },
  grid: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 12, marginTop: 16, border: "1px solid var(--rv-border)", borderRadius: 10, padding: 15 }, actions: { display: "flex", flexWrap: "wrap", gap: 10, marginTop: 15 },
  primary: { border: 0, borderRadius: 8, background: "#f4b942", color: "#101827", padding: "10px 13px", fontWeight: 900, cursor: "pointer" }, danger: { border: "1px solid #f87171", borderRadius: 8, background: "transparent", color: "var(--rv-error-text)", padding: "9px 12px", fontWeight: 800, cursor: "pointer" }, link: { border: "1px solid #60a5fa", borderRadius: 8, color: "var(--rv-info-text)", padding: "9px 12px", fontWeight: 800, textDecoration: "none" },
  safety: { color: "#93a4bb", fontSize: 12, margin: "14px 0 0" }, error: { border: "1px solid #ef4444", background: "var(--rv-error-bg)", color: "var(--rv-error-text)", borderRadius: 8, padding: 12, marginTop: 12 }, notice: { border: "1px solid #22c55e", background: "var(--rv-success-bg)", color: "var(--rv-success-text)", borderRadius: 8, padding: 12, marginTop: 12 }
};
