...
const styles = {
  ...
  subtitle: { color: "var(--rv-text-muted)", lineHeight: 1.6, maxWidth: 760 }, privateLabel: { border: "1px solid var(--rv-border)", borderRadius: 7, color: "var(--rv-text)", padding: "7px 10px", fontSize: 11, fontWeight: 900 },
  ...
  label: { display: "grid", gap: 7, marginBottom: 14, color: "var(--rv-text)", fontWeight: 800, fontSize: 13 }, input: { width: "100%", boxSizing: "border-box", border: "1px solid var(--rv-border)", borderRadius: 8, background: "var(--rv-input-bg)", color: "var(--rv-input-text)", padding: "11px 12px", font: "inherit" },
  textarea: { width: "100%", minHeight: 110, boxSizing: "border-box", border: "1px solid var(--rv-border)", borderRadius: 8, padding: 12, font: "inherit" }, textareaSmall: { width: "100%", minHeight: 72, boxSizing: "border-box", border: "1px solid var(--rv-border)", borderRadius: 8, padding: 12, font: "inherit" },
  primary: { border: 0, borderRadius: 8, background: "#f4b942", color: "#101827", padding: "12px 16px", fontWeight: 900, cursor: "pointer" }, approve: { border: 0, borderRadius: 7, background: "#22c55e", color: "#052e16", padding: "8px 11px", fontWeight: 900, cursor: "pointer" }, secondary: { border: "1px solid var(--rv-border)", borderRadius: 7, background: "transparent", color: "var(--rv-text)", padding: "8px 11px", fontWeight: 800, cursor: "pointer" }, danger: { border: "1px solid #f87171", borderRadius: 7, background: "transparent", color: "var(--rv-error-text)", padding: "8px 11px", fontWeight: 800, cursor: "pointer" },
  actions: { display: "flex", flexWrap: "wrap", gap: 8, marginTop: 14 }, list: { display: "grid", gap: 14 }, item: { border: "1px solid var(--rv-border)", borderRadius: 10, padding: 16, background: "var(--rv-surface)" }, itemHeader: { display: "flex", justifyContent: "space-between", gap: 14 }, itemTitle: { margin: "0 0 5px" },
  badge: { display: "inline-block", borderRadius: 5, padding: "4px 8px", fontSize: 11, fontWeight: 900, whiteSpace: "nowrap" }, hint: { color: "var(--rv-text-muted)", lineHeight: 1.5, fontSize: 13 }, body: { color: "var(--rv-text)", lineHeight: 1.55 }, meta: { display: "flex", flexWrap: "wrap", gap: "8px 18px", color: "var(--rv-text-muted)", fontSize: 13 }, legal: { borderLeft: "3px solid #f4b942", paddingLeft: 10, color: "var(--rv-warning-text)", lineHeight: 1.5 },
  inlineForm: { display: "grid", gridTemplateColumns: "minmax(240px,1fr) auto", gap: 10, alignItems: "end", marginTop: 14 }, compactLabel: { display: "grid", gap: 6, color: "#dce5f3", fontWeight: 800, fontSize: 12 }, workspace: { marginTop: 14, border: "1px solid var(--rv-border)", borderRadius: 8, padding: 12, color: "var(--rv-text)" }, nestedForm: { display: "grid", gap: 10, marginTop: 12 }, subItem: { borderTop: "1px solid #34445f", padding: "12px 0" }, fileRow: { display: "flex", justifyContent: "space-between", gap: 12, alignItems: "center", borderTop: "1px solid #34445f", padding: "10px 0" }, fileLink: { color: "#f4b942", fontWeight: 900 }, preWrap: { whiteSpace: "pre-wrap", lineHeight: 1.55, color: "var(--rv-text)" },
  history: { marginTop: 14, color: "var(--rv-text-muted)", cursor: "pointer" }, historyItem: { borderTop: "1px solid #34445f", paddingTop: 8, fontSize: 12, lineHeight: 1.5 }, error: { border: "1px solid #ef4444", background: "var(--rv-error-bg)", color: "var(--rv-error-text)", borderRadius: 8, padding: 12, marginBottom: 16 }, notice: { border: "1px solid #22c55e", background: "var(--rv-success-bg)", color: "var(--rv-success-text)", borderRadius: 8, padding: 12, marginBottom: 16 }, footerNote: { color: "var(--rv-text-muted)", fontSize: 12, lineHeight: 1.5, marginTop: 20 },
  creditTotals: { display: "flex", gap: 12, flexWrap: "wrap" }, creditForm: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 10, marginTop: 12 }, fundingWarning: { borderLeft: "3px solid #f59e0b", paddingLeft: 10, color: "var(--rv-warning-text)", fontWeight: 800 }, handoff: { marginTop: 14, border: "1px solid #0f766e", borderRadius: 8, background: "var(--rv-success-bg)", padding: 12 }
};
