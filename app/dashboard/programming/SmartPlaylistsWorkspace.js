    ...
    <section className={styles.panel} aria-labelledby="smart-playlists-title">
      ...
      {data?.canAuthor ? <form className={styles.smartPlaylistForm} onSubmit={save}>
        ...
        <div className={styles.formGrid}>
          ...
          <label><span>Cleared service</span><select value={form.rightsUse} onChange={(event) => setForm({ ...form, rightsUse: event.target.value })}><option value="ONLINE_RADIO">Online Radio</option><option value="RETAIL_RADIO">Retail Radio</option><option value="SCHOOL_RADIO">School Radio</option><option value="HEALTH_RADIO">Health Radio</option><option value="FAITH_RADIO">Faith Radio</option><option value="ORGANISATIONS_RADIO">Ruvanas Organisations</option></select></label>
