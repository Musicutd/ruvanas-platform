...
const styles = {
  page: { minHeight: "100vh", background: "#101827", color: "#fff", fontFamily: "Arial, sans-serif" }, content: { width: "min(1020px, calc(100% - 36px))", margin: "0 auto", padding: "44px 0 72px" }, back: { color: "#f4b942", fontWeight: 800, textDecoration: "none" }, eyebrow: { margin: "32px 0 10px", color: "#f4b942", fontSize: 12, fontWeight: 900, letterSpacing: 1.4 }, heading: { margin: 0, fontSize: "clamp(36px, 6vw, 56px)" }, lead: { color: "#bdc8d9", maxWidth: 760, fontSize: 17, lineHeight: 1.6 }, summary: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(190px, 1fr))", gap: 12, margin: "26px 0", padding: 18, borderRadius: 14, background: "#182235", border: "1px solid #2b3a54" }, card: { padding: 22, borderRadius: 14, background: "#182235", border: "1px solid #2b3a54" }, copy: { color: "#bdc8d9", lineHeight: 1.5 }, form: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(210px, 1fr))", gap: 12, alignItems: "end" }, field: { display: "grid", gap: 7, color: "#dce5f2", fontSize: 14, fontWeight: 800 }, input: { minHeight: 43, border: "1px solid #64748b", borderRadius: 8, padding: "9px 10px", background: "#fff", color: "#111827" }, primary: { minHeight: 43, border: 0, borderRadius: 8, padding: "10px 15px", background: "#f4b942", color: "#111827", fontWeight: 900 }, secondary: { minHeight: 40, border: "1px solid #64748b", borderRadius: 8, padding: "8px 12px", background: "#24334b", color: "#fff", fontWeight: 800 }, warning: { color: "#fde68a", fontWeight: 800 }, notice: { display: "grid", gap: 7, marginTop: 24, padding: 20, borderRadius: 12, border: "1px solid #f4b942", background: "#2f291c", color: "#fde68a" }, success: { padding: 13, borderRadius: 9, background: "#153c2d", color: "#bbf7d0", fontWeight: 800 }, error: { padding: 13, borderRadius: 9, background: "#481b24", color: "#fecaca", fontWeight: 800 }, list: { display: "grid", gap: 15, marginTop: 30 }, location: { padding: 21, borderRadius: 14, background: "#182235", border: "1px solid #2b3a54" }, locationHeader: { display: "flex", justifyContent: "space-between", gap: 16, alignItems: "flex-start" }, locationTitle: { margin: 0, fontSize: 24 }, meta: { display: "block", color: "#9cacbf", fontSize: 12, marginTop: 5 }, badge: { padding: "5px 8px", borderRadius: 999, background: "#14532d", color: "#bbf7d0", fontSize: 11, fontWeight: 900 }, rename: { display: "flex", gap: 8, flexWrap: "wrap", marginTop: 12 }, zones: { display: "grid", gap: 9, marginTop: 18 }, zone: { display: "flex", justifyContent: "space-between", gap: 15, flexWrap: "wrap", padding: 13, borderRadius: 9, background: "#111c2e" }, addZone: { display: "flex", gap: 10, flexWrap: "wrap", alignItems: "end", marginTop: 17 }, returnButton: { display: "inline-flex", marginTop: 24, padding: "12px 16px", borderRadius: 9, background: "#f4b942", color: "#111827", fontWeight: 900, textDecoration: "none" }
};
