...
export default function PlayerPage() {
  ...
  return <main style={styles.page}><section style={styles.card}>
    ...
    {state.channel?.streamUrl ? <>
      ...
      <p style={styles.online}>Online - health heartbeat active</p>
    </> : <div style={styles.waiting}>No playable channel is assigned to this zone yet. This player will update after the assignment is configured.</div>}
    {message ? <p style={styles.error}>{message}</p> : null}
  </section></main>;
}
