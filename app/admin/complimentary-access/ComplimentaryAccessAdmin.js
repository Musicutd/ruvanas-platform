  ...
  return (
    <main style={s.page}>
      ...
      <section style={s.section} aria-labelledby="issue-heading">
        ...
        {selectedPlan ? <div style={s.validityNotice}><strong>Access rule:</strong> {selectedPlan.name} remains free and active with no expiry date until a Ruvanas Super Admin stops it.</div> : null}
