...
export async function GET() {
  ...
  const readiness = await prisma.schoolSafeguardingReadiness.findUnique({ where: { organisationId: access.organisation.id } });
  ...
  return NextResponse.json({
    ...
    permissions: { canManage: ORGANISATION_MANAGER_ROLES.includes(access.membership.role) }
  });
}
